            ...
            onTap: () {
              ...
              Navigator.of(context).push(
                showPicker(
                  ...
                  elevation: 12,
                  context: context,
                  value: toTime(selectedTime), // Convert TimeOfDay to Time
                  is24HrFormat: true,
                  onChange: (value) => setState(() {
                    selectedTime = toTimeOfDay(value); // Convert Time to TimeOfDay
                    model.time = selectedTime.format(context);
                  }),
                ),
              );
